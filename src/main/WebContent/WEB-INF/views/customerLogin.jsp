...
<html>
	...
	<body>
	    <div class="container">
	        ...
	        <form id="user_form" action="${pageContext.request.contextPath}/customer/loginResult" method="POST">
	            ...
	            <button id="confirm_user" type="submit" class="btn btn-primary">Confirm Identity</button>
	        </form>
	    </div>
	</body>
</html>